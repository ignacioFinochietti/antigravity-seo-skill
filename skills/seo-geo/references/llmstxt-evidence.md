# `/llms.txt` â€” evidence-based reframe (June 2026)
...
it as a Google ranking or citation lever in any antigravity-seo report.
...
| **John Mueller** (Google) â€” Reddit + Bluesky | 2025 | "No AI system currently uses llms.txt." Compared the file to deprecated meta keywords. |
| **Gary Illyes** (Google) â€” Search Central Live | July 2025 | Google has no plans to support llms.txt. |
| **SE Ranking** â€” 300k-domain study | November 2025 | Among the 50 most AI-cited domains, **only one** had an `/llms.txt`. |
| **OtterlyAI** â€” server-log audit | 2025 | **0.1%** of AI-bot traffic targets `/llms.txt` (84 of 62,100 requests). |
| **Anthropic, Stripe, Cloudflare, NVIDIA** â€” published files | 2024â€“2025 | All publish `llms.txt`. **None** have stated their crawlers consume third-party `llms.txt` files. |
...
`llms.txt` is a net win â€” it helps agents quote the docs accurately.
...
## How antigravity-seo treats `llms.txt`
...
- If the user asks to generate one, antigravity-seo produces a minimal valid
